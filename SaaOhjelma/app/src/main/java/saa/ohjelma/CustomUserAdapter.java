...
public class CustomUserAdapter extends ArrayAdapter<Article> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.county_item, parent, false);
        }
        ...
        btButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                Intent intent = new Intent(view.getContext(), WeatherActivty.class);
                Article article = getItem(position);
                intent.putExtra("muncipality",article.articleName);
