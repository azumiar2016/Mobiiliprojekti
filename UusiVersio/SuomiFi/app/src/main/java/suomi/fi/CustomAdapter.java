    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        button.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                {
                    case "Palveluluokat":
                        Intent intent = new Intent(view.getContext(), Kohde.class);
                        intent.putExtra(key, "KEYpalveluluokat");
                        view.getContext().startActivity(intent);
                        break;

                    case "Maakunnat":
                        Intent intent2 = new Intent(view.getContext(), Kohde.class);
                        intent2.putExtra(key, "KEYmaakunnat");
                        view.getContext().startActivity(intent2);
                        break;

                    case "Asiasanat":
                        Intent intent3 = new Intent(view.getContext(), Kohde.class);
                        intent3.putExtra(key, "KEYasiasanat");
                        view.getContext().startActivity(intent3);
                        break;

                    case "Organisaatiot":
                        Intent intent4 = new Intent(view.getContext(), Kohde.class);
                        intent4.putExtra(key, "KEYorganisaatiot");
                        view.getContext().startActivity(intent4);
                        break;

                    case "Lomakkeet":
                        Intent intent5 = new Intent(view.getContext(), Kohde.class);
                        intent5.putExtra(key, "KEYlomakkeet");
                        view.getContext().startActivity(intent5);
                        break;

                    case "Linkit":
                        Intent intent6 = new Intent(view.getContext(), Kohde.class);
